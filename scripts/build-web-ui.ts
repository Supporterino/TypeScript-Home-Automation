...
const OUT_JS = join(ROOT, "src/core/web-ui/assets/app-js.ts");
const OUT_CSS = join(ROOT, "src/core/web-ui/assets/style-css.ts");
...
await Bun.write(
  OUT_JS,
  `/** Auto-generated by scripts/build-web-ui.ts — do not edit directly. */\nexport const JS = ${JSON.stringify(js)};\n`,
);
...
console.log(`[build-web-ui] Done. JS: ${jsSizeKb} KB, CSS: ${cssSizeKb} KB`);
